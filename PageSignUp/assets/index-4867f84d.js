...
`;function qg({status:e,DMList:t,Mod:n,handleSetMod:r,myId:i,handleGetList:o}){const[l,s]=O.useState(""),[a,u]=O.useState([]),[f,m]=O.useState([]),g=O.useCallback(v=>{m(v)},[]),y=O.useCallback(v=>{s(v)},[]),x=O.useCallback(v=>{u(v)},[]);return h.jsxs(Gg,{status:e,children:[h.jsxs(Jg,{children:[h.jsx("span",{children:"쪽지"}),h.jsxs(Yg,{children:[h.jsx(lc,{children:h.jsx(Cg,{fontSize:"25px"})}),h.jsx(lc,{onClick:()=>{r("chatlist"),o()},children:h.jsx(dg,{})})]})]}),n==="chatlist"?h.jsx(Kg,{DMList:t,handleSetMod:r,myId:i,handleSetTargetId:y,handlesetChatTarget:x,handleSetData:g},`chat list ${i}`):n==="chat"?h.jsx(Dg,{chatData:f,chatTarget:a,myId:i,targetId:l,handleSetData:g},`chat room ${l}`):"none"]})}const Xg=N.div`
  display: flex;
  justify-content: center;
  align-items: center;
  padding: 10px;
...
`),T!==""){alert(T.trim());return}const L=JSON.stringify({memberNickname:Qe,memberId:Oe,memberPw:_e,memberRole:Xr,memberAcademy:Zr,memberStack:JSON.stringify(tn),memberLink:JSON.stringify(t.map(tt=>({option:tt.option,value:tt.value}))),memberIntroduce:za});console.log(L);let X={method:"post",maxBodyLength:1/0,url:"/api/memberRegister",headers:{"Content-Type":"application/json"},data:L};Wt.request(X).then(tt=>{console.log(JSON.stringify(tt.data)),alert("회원가입이 완료되었습니다."),window.location.href="http://projecttycoon.com/api/login"}).catch(tt=>{console.log(tt)})};return h.jsx(ex,{className:"Contents",children:h.jsxs(Zg,{children:[h.jsxs(nx,{children:["Tycoon에 오신 걸 환영합니다 !",h.jsx(cg,{size:"34",className:"rabbit"})]}),h.jsxs("div",{className:"NickArea",children:[h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"닉네임"]}),h.jsx(ix,{placeholder:"사용하실 닉네임을 작성해 주세요",value:Qe,onChange:T=>{T.preventDefault();const L=T.target.value;pt(L),qr.test(L)?Ca(""):Ca("2~12자의 한글, 영문, 숫자, '_', '-'만 사용할 수 있습니다.")}}),h.jsx(ac,{onClick:()=>{rp(Qe)},children:"중복 체크"}),C&&h.jsx(rc,{onClose:closeNickModal,children:"중복 체크"})]}),Ea&&h.jsx(nn,{children:Ea}),E!==void 0?E?h.jsx(ie,{children:"사용 가능한 닉네임입니다."}):h.jsx(ie,{children:"이미 사용중인 닉네임입니다."}):"",h.jsxs("div",{className:"IdArea",children:[h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"아이디"]}),h.jsx(rx,{placeholder:"사용하실 아이디를 작성해 주세요",value:Oe,onChange:T=>{T.preventDefault();const L=T.target.value;tp(L),Xn.test(L)?Sa(""):Sa("4~15자의 영문, 숫자, '_', '-'만 사용할 수 있습니다.")}}),h.jsx(ac,{onClick:()=>{np(Oe)},children:"중복 체크"}),p&&h.jsx(rc,{onClose:closeIdModal,children:"중복 체크"})]}),ka&&h.jsx(nn,{children:ka}),U!==void 0?U?h.jsx(ie,{children:"사용 가능한 아이디입니다."}):h.jsx(ie,{children:"이미 사용중인 아이디입니다."}):"",h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"비밀번호"]}),h.jsx(sc,{type:"password",placeholder:"영문, 숫자, 특수문자 포함 8자리 이상 입력해 주세요",value:_e,onChange:T=>{const L=T.target.value;P(L),Zt.test(L)?(console.log("Password meets criteria"),I("")):(console.log("Password does not meet criteria"),I("영문, 숫자, 특수문자 포함 8자리 이상 입력해 주세요"))}}),A&&h.jsx(nn,{children:A}),h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"비밀번호 확인"]}),h.jsx(sc,{type:"password",placeholder:"비밀번호를 한번 더 입력해 주세요",value:V,onChange:T=>{T.preventDefault();const L=T.target.value;te(L),et(L!==_e?"비밀번호가 일치하지 않습니다.":"")}}),en&&h.jsx(nn,{children:en}),h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"직무"]}),h.jsxs("select",{value:Xr,onChange:T=>op(T.target.value),children:[h.jsx("option",{value:"",children:"선택"}),h.jsx("option",{value:"back",children:"백엔드"}),h.jsx("option",{value:"front",children:"프론트엔드"}),h.jsx("option",{value:"bigdata",children:"빅데이터"}),h.jsx("option",{value:"ai",children:"AI"}),h.jsx("option",{value:"server",children:"서버관리자"}),h.jsx("option",{value:"security",children:"정보보안"}),h.jsx("option",{value:"network",children:"네트워크관리자"})]}),!Xr&&h.jsx(nn,{children:"직무를 선택해 주세요."}),h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"학원지점"]}),h.jsxs("select",{value:Zr,onChange:T=>lp(T.target.value),children:[h.jsx("option",{value:"",children:"선택"}),h.jsx("option",{value:"강남",children:"강남"}),h.jsx("option",{value:"신촌/홍대",children:"신촌/홍대"}),h.jsx("option",{value:"노원",children:"노원"}),h.jsx("option",{value:"대전",children:"대전"}),h.jsx("option",{value:"대구",children:"대구"}),h.jsx("option",{value:"인천",children:"인천"}),h.jsx("option",{value:"부산",children:"부산"})]}),!Zr&&h.jsx(nn,{children:"학원지점을 선택해 주세요."}),h.jsxs(mt,{children:[h.jsx("span",{children:"*"}),"기술스택",h.jsx("span",{className:"MultipleChoice",children:"※ 복수 선택 가능"})]}),h.jsxs(cx,{children:[ap(),h.jsxs(dx,{onChange:T=>{if(T.preventDefault(),T.target.value!==""){let L=[...tn,T.target.value];ja(L),sp("")}},children:[h.jsx("option",{value:"",children:"선택"}),h.jsx("option",{value:"Java",children:"Java"}),h.jsx("option",{value:"Python",children:"Python"}),h.jsx("option",{value:"C",children:"C"}),h.jsx("option",{value:"C++",children:"C++"}),h.jsx("option",{value:"C#",children:"C#"}),h.jsx("option",{value:"PHP",children:"PHP"}),h.jsx("option",{value:"SQL",children:"SQL"}),h.jsx("option",{value:"Kotlin",children:"Kotlin"}),h.jsx("option",{value:"Go",children:"Go"}),h.jsx("option",{value:"R",children:"R"}),h.jsx("option",{value:"HTML",children:"HTML"}),h.jsx("option",{value:"CSS",children:"CSS"}),h.jsx("option",{value:"JavaScript",children:"JavaScript"}),h.jsx("option",{value:"TypeScript",children:"TypeScript"}),h.jsx("option",{value:"NodeJs",children:"Node.js"}),h.jsx("option",{value:"JQuery",children:"JQuery"}),h.jsx("option",{value:"React",children:"React"}),h.jsx("option",{value:"Vue",children:"Vue"})]})]}),Na&&h.jsx(nn,{children:Na}),h.jsx(mt,{children:"한 줄 소개"}),h.jsx(px,{value:za,onChange:T=>{T.preventDefault(),ip(T.currentTarget.value)},spellCheck:"false",placeholder:"본인을 소개해주세요!"}),h.jsx(mt,{children:"Link"}),t.map((T,L)=>h.jsxs(ox,{style:{display:"flex",alignItems:"center",gap:"10px",marginLeft:(L>0,"0px")},onClick:()=>c(L),children:[h.jsxs("div",{className:"LinkForm",children:[h.jsxs(sx,{onClick:()=>d(L),children:[T.option," ",h.jsx(sg,{style:{position:"absolute",right:"5px"}})]}),T.isOpen&&h.jsxs(lx,{children:[h.jsxs(xl,{onClick:()=>y(L,"Git"),children:["Git ",h.jsx(ag,{})]}),h.jsxs(xl,{onClick:()=>y(L,"Blog"),children:["Blog ",h.jsx(ug,{})]}),h.jsxs(xl,{onClick:()=>y(L,"Other"),children:["그 외 ",h.jsx(mg,{})]})]})]}),h.jsx(ax,{placeholder:" 주소를 모두 입력해주세요.",value:T.value,onChange:X=>x(L,X.target.value)}),L!==0&&h.jsx("div",{className:"delete-button",onClick:()=>g(L),children:h.jsx(fg,{className:"deleteBtn"})})]},L)),h.jsx("div",{className:"plus-button",onClick:m,children:h.jsx(pg,{size:"45",className:"PlusBtn"})}),h.jsx(ux,{onClick:up,children:"SignUp"}),h.jsx(tx,{children:h.jsx(kg,{})}),h.jsx(qg,{status:o,DMList:r,Mod:s,myId:e==null?void 0:e.memberId,handleSetMod:u,handleGetList:f}),h.jsx(Xg,{onClick:()=>{l(!o),a("chatlist"),o||f()},status:o,children:h.jsx(Eg,{})})]})})}const mx=N.div`
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
  align-items: center;
...
`,gx=N.div`
  max-width: 1440px;
`;function xx(){const[e,t]=O.useState(""),n=O.useCallback(r=>{t(r)},[]);return h.jsxs(mx,{children:[h.jsx(ig,{userData:e,handleSetUserData:n}),h.jsx(gx,{children:h.jsx(hx,{userData:e})})]})}vl.createRoot(document.getElementById("root")).render(h.jsx(wt.StrictMode,{children:h.jsx(xx,{})}));
